  ...
  return (
    <AuthProvider>
      <Head>
        ...
        <meta property="og:image" content="https://cinesync-os.vercel.app/og-hero.png?v=3" />
        <meta property="og:image:secure_url" content="https://cinesync-os.vercel.app/og-hero.png?v=3" />
